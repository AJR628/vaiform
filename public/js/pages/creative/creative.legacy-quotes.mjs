import { BACKEND as BACKEND_FROM_CONFIG } from '/config.js';
        ...
        (async function bootLegacyDeps() {
            ...
            try {
                ...
                window.getSavedOverlayMeta = window.getSavedOverlayMeta || function() { return null; };
            ...
            try {
                ...
                if (payload.overlayCaption) {
                  ...
                  if (Number.isFinite(fontPx) && Number.isFinite(lineSpacingPx) && 
                    ...
                    console.log('[render-INVARIANT] ✅ Client totalTextH validation passed:', { totalTextH, expectedTotalTextH });
                  }
                }
