...
const MODEL = "ideogram-ai/ideogram-v3-turbo:32a9584617b239dd119c773c8c18298d310068863d26499e6199538e9c29a586";
...
export default {
  ...
  async invoke({ prompt, params = {} }) {
    ...
    const input = {
      ...
      magic_prompt_option: params.magic_prompt_option ?? params.magicPrompt ?? this.defaults.magic_prompt_option,
