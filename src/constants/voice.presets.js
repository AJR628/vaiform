...
export const VOICE_PRESETS = {
  ...
  male_calm: {
    ...
    emotion: 'calm',
    voiceId:
      process.env.ELEVEN_VOICE_ID_MALE_CALM ||
      process.env.ELEVEN_VOICE_ID ||
      'pNInz6obpgDQGcFmaJgB', // Default to Adam if not set
    voiceSettings: {
      stability: 0.6,
  ...
  male_energetic: {
    ...
    emotion: 'energetic',
    voiceId:
      process.env.ELEVEN_VOICE_ID_MALE_ENERGETIC ||
      process.env.ELEVEN_VOICE_ID ||
  ...
  male_dramatic: {
    ...
    emotion: 'dramatic',
    voiceId:
      process.env.ELEVEN_VOICE_ID_MALE_DRAMATIC ||
      process.env.ELEVEN_VOICE_ID ||
      'pNInz6obpgDQGcFmaJgB',
    voiceSettings: {
      stability: 0.5,
  ...
  male_friendly: {
    ...
    emotion: 'friendly',
    voiceId:
      process.env.ELEVEN_VOICE_ID_MALE_FRIENDLY ||
      process.env.ELEVEN_VOICE_ID ||
      'pNInz6obpgDQGcFmaJgB',
    voiceSettings: {
      stability: 0.55,
  ...
  female_calm: {
    ...
    emotion: 'calm',
    voiceId:
      process.env.ELEVEN_VOICE_ID_FEMALE_CALM ||
      process.env.ELEVEN_VOICE_ID ||
      'EXAVITQu4vr4xnSDxMaL', // Default to Bella if not set
    voiceSettings: {
      stability: 0.6,
      similarity_boost: 0.75,
      style: 0.2,
  ...
  female_energetic: {
    ...
    emotion: 'energetic',
    voiceId:
      process.env.ELEVEN_VOICE_ID_FEMALE_ENERGETIC ||
      process.env.ELEVEN_VOICE_ID ||
  ...
  female_dramatic: {
    ...
    emotion: 'dramatic',
    voiceId:
      process.env.ELEVEN_VOICE_ID_FEMALE_DRAMATIC ||
      process.env.ELEVEN_VOICE_ID ||
      'EXAVITQu4vr4xnSDxMaL',
    voiceSettings: {
      stability: 0.5,
  ...
  female_friendly: {
    ...
    emotion: 'friendly',
    voiceId:
      process.env.ELEVEN_VOICE_ID_FEMALE_FRIENDLY ||
      process.env.ELEVEN_VOICE_ID ||
      'EXAVITQu4vr4xnSDxMaL',
    voiceSettings: {
      stability: 0.55,
