...
import { enforceFreeLifetimeShortLimit, enforceWatermarkFlag } from "../middleware/planGuards.js";
import { createShort, getShortById, getMyShorts, deleteShort } from "../controllers/shorts.controller.js";

const r = Router();

r.post("/create", requireAuth, enforceFreeLifetimeShortLimit(4), enforceWatermarkFlag(), createShort);
