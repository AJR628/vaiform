...
const CaptionStyleSchema = z.object({
  ...
  fontPx: z.number().int().finite().min(16).max(400).default(44),
  lineSpacingPx: z.number().int().finite().min(0).max(400).default(52),
...
const OverlaySchema = z.object({
  ...
  fontPx: z.coerce.number().int().finite().min(16).max(400).optional(),
  sizePx: z.coerce.number().int().finite().min(16).max(400).optional(), // alias
