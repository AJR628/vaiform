...
function emit(level, event, details = {}) {
  ...
  const entry = compact({
    ...
    level,
    event,
    sourceRole: context.sourceRole ?? undefined,
    ...
    finalizeJobId: context.finalizeJobId ?? undefined,
    executionAttemptId: context.executionAttemptId ?? undefined,
    workerId: context.workerId ?? undefined,
    jobState: context.jobState ?? undefined,
