...
async function testPreviewRenderParity() {
  ...
  try {
    ...
    const requiredFields = [
      'ssotVersion', 'mode', 'frameW', 'frameH', 'bgScaleExpr', 'bgCropExpr',
      'rasterUrl', 'rasterW', 'rasterH', 'xExpr', 'yPx', 'rasterHash'
    ];
    ...
    if (meta.rasterW >= 1080 || meta.rasterH >= 1920) {
      throw new Error(`Raster dimensions too large: ${meta.rasterW}×${meta.rasterH} (should be tight PNG < 600px)`);
    }
