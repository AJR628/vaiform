...
async function main() {
  ...
  const endpoints = [
    ...
    {
      path: '/api/quotes/generate-quote',
      method: 'POST',
      body: { text: 'test quote', tone: 'motivational' },
    },
    {
      path: '/api/quotes/remix',
      method: 'POST',
  ...
  log(
    colors.yellow,
    '1. Open https://17e0d1d1-e327-483d-b1ea-c41bea08fb59-00-1ef93t84nlhq6.janeway.replit.dev/creative in browser'
  );
