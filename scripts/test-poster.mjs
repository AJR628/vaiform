...
async function main(){
  ...
  await sh(['-y','-f','lavfi','-i','color=c=black:s=320x240:d=1','-c:v','libx264','-pix_fmt','yuv420p', videoPath]);
...
main().catch((e) => { console.error('[test-poster] FAIL:', e?.message || e); process.exit(1); });
