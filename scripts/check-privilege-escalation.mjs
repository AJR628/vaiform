...
if (issues.length > 0) {
  ...
  console.error('These endpoints must NEVER be mounted without proper authentication and authorization.');
  console.error('If you need admin functionality, create separate admin-only routes with role checks.\n');
  process.exit(1);
} else {
