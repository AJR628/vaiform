...
- The creative storyboard step now auto-runs `/api/story/sync` after `plan -> search` and lands in a preview-first storyboard shell backed by synced narration timing.
