...
- For active/default routes, define schema in `src/schemas/*.schema.js` and apply `validate(...)` (`src/routes/checkout.routes.js:4-5,20,23`, `src/routes/assets.routes.js:3-4,10`).
